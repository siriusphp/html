...
class BuilderTest extends \PHPUnit_Framework_TestCase
{
    ...
    function testCustomTag() {
        $this->assertEquals('<other-tag>Content</other-tag>', $this->builder->make('some-tag', null, 'Content')->render());
    }
    
    function testMagicCall() {
        $this->assertEquals('<other-tag>Content</other-tag>', $this->builder->someTag(null, 'Content')->render());
    }
    
    function testRegisteredTag() {
        $this->assertEquals('<img src="some/file.jpg">', $this->builder->img(array('src' => 'some/file.jpg')));
    }
    
    function testNonRegisteredTag() {
        $this->assertEquals('<hr class="separator">', $this->builder->make('hr/', array('class' => 'separator')));
    }
